    ...
    <div class="flex h-screen overflow-hidden" x-data="{ mobileOpen: false }">
        ...
        <aside id="main-sidebar" class="w-64 bg-emerald-900 text-white flex flex-col shadow-2xl flex-shrink-0 fixed inset-y-0 left-0 z-40 transform transition-transform duration-300 lg:relative lg:inset-auto lg:translate-x-0"
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto overflow-x-hidden custom-scrollbar-dark">
                ...
                <a href="{{ route('admin.penyewa') }}" class="nav-item flex items-center px-4 py-3 {{ (request()->routeIs('admin.penyewa') || request()->routeIs('admin.penyewa.*')) ? 'bg-emerald-800 text-white shadow-lg translate-x-1' : 'text-emerald-100 hover:bg-emerald-800/50 hover:text-white' }} rounded-xl transition-all duration-200 group">
                    <svg class="w-5 h-5 flex-shrink-0 mr-3 {{ (request()->routeIs('admin.penyewa') || request()->routeIs('admin.penyewa.*')) ? 'text-emerald-400' : 'text-emerald-300 group-hover:text-white' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
