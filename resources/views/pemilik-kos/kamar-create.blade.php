...
@section('header')
    <div class="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <a href="{{ route('owner.kamar') }}" class="bg-gray-600 hover:bg-gray-700 text-white text-sm font-bold py-3 px-6 rounded-xl shadow-md transition flex items-center">
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <form action="{{ route('owner.kamar.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    @if($tipeKamar->isEmpty())
                        <p class="text-amber-600 text-xs mt-2">Belum ada tipe kamar. Tambahkan tipe kamar dulu di menu Pengaturan/Tipe Kamar.</p>
                    @endif
                </div>
                ...
                <div>
                    ...
                    @error('status')
                        <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                    @enderror
                    <p class="text-xs text-gray-500 mt-2">Kamar tidak bisa langsung "Terisi" saat ditambahkan.</p>
                </div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        name="notes"
                        rows="3"
                        placeholder="Contoh: Kamar dengan jendela besar, dekat tangga, dll."
