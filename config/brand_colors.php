...
/*
 * Palet warna dasar (brand) yang bisa dipilih owner untuk dashboard-nya.
 * Tiap palet = channel "R G B" per shade (dipetakan ke --c-em-* di app.css,
 * yang menggerakkan seluruh utilitas emerald Tailwind). Nilai = palet Tailwind.
 * 'swatch' = warna -600 (hex) untuk pratinjau tombol pilihan.
 */
return [
    'emerald' => [
